...
###################################################################################
#
# based on botan.io python api
#
# Source: https://github.com/botanio/sdk/blob/master/botan.py
#
###################################################################################
...
BOTAN = os.environ.get('BOTAN', None)
...
def track(uid, message, name='Message'):
    try:
        r = requests.post(
            TRACK_URL,
            params={"token": BOTAN, "uid": uid, "name": name},
